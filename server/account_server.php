...
require_once('conexion.php');
    ...
    $carpeta = "../images/profesor/";

    if(is_dir($carpeta)){
        $src = $carpeta.$nombre_a;
        $src_1 = "images/profesor/$nombre_a";
        move_uploaded_file($ruta_p,$src);
        $valor = "UPDATE profesor SET usuario='$usuario', email = '$email', Nombre = '$nombre', Apellido = '$apellido', cedula = '$cedula', perfil = '$src_1' WHERE usuario = '$usuario'";
